...
<div class="btn-group">
  <a href="https://jaterli.github.io/CSS-entregable-1/" target="_blank" class="flex items-center btn btn-neutral"> 
    <svg class="w-5 h-5" fill="currentColor"> <use href="/assets/icons.svg#icon-web"></use> </svg>
    <span>Ver Proyecto en Vivo</span>
  </a>
  <a href="https://github.com/Jaterli/CSS-entregable-1" target="_blank" class="flex items-center btn btn-primary"> 
